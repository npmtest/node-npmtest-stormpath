...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/Client.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/Client.js</span></h1>
    <h2>
        
        Statements: <span class="metric">31.61% <small>(61 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">15.25% <small>(9 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">9.62% <small>(5 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">31.61% <small>(61 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/</a> &#187; Client.js</div>
</div>
<div class="body">
...
1227
1228
1229</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        self.config = loadedConfig;</span>
<span class="cstat-no" title="statement not covered" >        self._dataStore = new DataStore(loadedConfig);</span>
<span class="cstat-no" title="statement not covered" >        self._isReady = true;</span>
<span class="cstat-no" title="statement not covered" >        awaitReadyProxy.detach();</span>
<span class="cstat-no" title="statement not covered" >        self.emit('ready', self);</span>
      }
    });
  });
}
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (args.length === 2 &amp;&amp; args[0] === 'ready' &amp;&amp; typeof args[1] === 'function') {
    var callback = args[1];
 ...
 * });
 */
Client.prototype.getAccessToken = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/accessTokens/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Access Token'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/AccessToken'), args.callback);</span>
};
&nbsp;
 ...
 * });
 */
Client.prototype.getRefreshToken = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/refreshTokens/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Refresh Token'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/RefreshToken'), args.callback);</span>
};
&nbsp;
/**
 ...
 */
Client.prototype.getCurrentTenant = <span class="fstat-no" title="function not covered" >function() {</span>
...
&nbsp;
  ...
  // multiple times.
<span class="cstat-no" title="statement not covered" >  if (self._currentTenant) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(null, self._currentTenant);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._dataStore.getResource('/tenants/current', args.options, require('./resource/Tenant'), <span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    self._currentTenant = tenant;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return args.callback(null, tenant);</span>
  });
};
&nbsp;
/**
 ...
 */
Client.prototype.getResource = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this._dataStore.getResource.apply(this._dataStore, arguments);</span>
};
&nbsp;
/**
 * @private
 ...
 * });
 */
Client.prototype.getApplications = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getApplications(args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.createApplication = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['app', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.createApplication(args.app, args.options, args.callback);</span>
  });
};
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getAccounts(args.options, args.callback);</span>
  });
};
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getGroups(args.options, args.callback);</span>
  });
};
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getDirectories(args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.createDirectory = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['dir', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.createDirectory(args.dir, args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.createOrganization = <span class="fstat-no" title="function not covered" >function createOrganization() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['data', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.createOrganization(args.data, args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getAccount = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/accounts/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Account'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Account'), args.callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/applications/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Application'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Application'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getChallenge = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Challenge'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getDirectory = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/directories/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Directory'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Directory'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getFactor = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, FactorInstanceCtor, args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getGroup = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/groups/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Group'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Group'), args.callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/groupMemberships/')) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/GroupMembership'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getOrganization = <span class="fstat-no" title="function not covered" >function getOrganization() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.isValidHref(args.href, '/organizations/')) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Organization'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Organization'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getOrganizations = <span class="fstat-no" title="function not covered" >function getOrganizations(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function onGetCurrentTenantForGroups(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err, null);</span>
    }
<span class="cstat-no" title="statement not covered" >    return tenant.getOrganizations(args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getPhone = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/Phone'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getIdSites = <span class="fstat-no" title="function not covered" >function getIdSites(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getIdSites(args.options, args.callback);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
Client.prototype.getSmtpServer = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);</span>
<span class="cstat-no" title="statement not covered" >  return this.getResource(args.href, args.options, require('./resource/SmtpServer'), args.callback);</span>
};
&nbsp;
/**
