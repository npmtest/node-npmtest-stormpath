...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/resource/CollectionResource.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/resource/CollectionResource.js</span></h1>
    <h2>
        
        Statements: <span class="metric">14.21% <small>(27 / 190)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">3.03% <small>(2 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">4.92% <small>(3 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">14.52% <small>(27 / 186)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/resource/</a> &#187; CollectionResource.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function wrapAsyncCallToAllPages(coll, func, args, callbackWrapper){</span>
<span class="cstat-no" title="statement not covered" >  var page = _.pick(coll, [</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function getNextPage(page, callback) {</span>
    // There is no next page.
<span class="cstat-no" title="statement not covered" >    if (page.items.length &lt; page.limit) {</span>
...
<span class="cstat-no" title="statement not covered" >    var nextQuery = utils.shallowCopy(page.query, {});</span>
<span class="cstat-no" title="statement not covered" >    nextQuery.offset = page.offset + page.items.length;</span>
<span class="cstat-no" title="statement not covered" >    nextQuery.limit = 100;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    page.dataStore.getResource(page.href, nextQuery, page.instanceConstructor,</span>
<span class="fstat-no" title="function not covered" >      function onNextPage(err, collectionResource) {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          return callback(err);</span>
        }
<span class="cstat-no" title="statement not covered" >        (typeof setImmediate !== 'undefined' ?</span>
          setImmediate : process.nextTick)(<span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >          callback(null, collectionResource);</span>
        });
      });
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function worker(task, cb){</span>
<span class="cstat-no" title="statement not covered" >    if (!task.collection.items || !task.collection.items.length){</span>
...
<span class="fstat-no" title="function not covered" >      function(parallel_cb){</span>
<span class="cstat-no" title="statement not covered" >        if (callbackWrapper.isDone){</span>
<span class="cstat-no" title="statement not covered" >          return parallel_cb();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var callArgs = Array.prototype</span>
          .concat(
...
<span class="cstat-no" title="statement not covered" >        func.apply(this, callArgs);</span>
      },
<span class="fstat-no" title="function not covered" >      function(parallel_cb){</span>
<span class="cstat-no" title="statement not covered" >        if (callbackWrapper.isDone){</span>
<span class="cstat-no" title="statement not covered" >          return parallel_cb();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        getNextPage(task.collection, <span class="fstat-no" title="function not covered" >function(err, nextPage){</span></span>
<span class="cstat-no" title="statement not covered" >          if (err || !nextPage){</span>
<span class="cstat-no" title="statement not covered" >            return parallel_cb(err);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          q.push({collection: nextPage});</span>
<span class="cstat-no" title="statement not covered" >          parallel_cb();</span>
        });
      }
    ], cb);
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var q = async.queue(worker, 1);</span>
<span class="cstat-no" title="statement not covered" >  q.drain = callbackWrapper.wrapCallback(callback);</span>
<span class="cstat-no" title="statement not covered" >  q.push({ collection: page });</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function ensureInstanceResources(items, InstanceConstructor, dataStore) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var InstanceCtor = utils.valueOf(InstanceConstructor, InstanceResource);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!items || items.length === 0 || items[0] instanceof InstanceCtor /* already converted */) {</span>
<span class="cstat-no" title="statement not covered" >    return items;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var convertedItems = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; items.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    var obj = items[i];</span>
...
<span class="cstat-no" title="statement not covered" >    var converted = require('./ResourceFactory').instantiate(InstanceCtor, obj, null, dataStore);</span>
<span class="cstat-no" title="statement not covered" >    convertedItems.push(converted);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return convertedItems;</span>
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function CollectionResource(/*data, query, InstanceCtor, dataStore*/) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var dataStore = args[args.length - 1];</span>
<span class="cstat-no" title="statement not covered" >  var query = null;</span>
<span class="cstat-no" title="statement not covered" >  var InstanceCtor = InstanceResource; </span>// Default for generic resource instances.
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    InstanceCtor = secondToLastArg;</span>
  }
&nbsp;
  // Convert raw items array (array of objects) to an array of Instance Resources.
<span class="cstat-no" title="statement not covered" >  if (data &amp;&amp; data.hasOwnProperty('items') &amp;&amp; data.items.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    data.items = ensureInstanceResources(data.items, InstanceCtor, dataStore);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  CollectionResource.super_.apply(this, [data, dataStore]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Object.defineProperty(this, 'instanceConstructor', {</span>
    get: <span class="fstat-no" title="function not covered" >function getInstanceConstructor() {</span>
<span class="cstat-no" title="statement not covered" >      return InstanceCtor;</span>
    },
    set: <span class="fstat-no" title="function not covered" >function setInstanceConstructor(TheInstanceCtor) {</span>
<span class="cstat-no" title="statement not covered" >      InstanceCtor = TheInstanceCtor;</span>
    }
  });
<span class="cstat-no" title="statement not covered" >  this.instanceConstructor = InstanceCtor;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Object.defineProperty(this, 'query', {</span>
    get: <span class="fstat-no" title="function not covered" >function getQuery() {</span>
<span class="cstat-no" title="statement not covered" >      return query;</span>
    },
    set: <span class="fstat-no" title="function not covered" >function setQuery(aQuery) {</span>
<span class="cstat-no" title="statement not covered" >      query = aQuery;</span>
    }
  });
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function CallbackWrapper(argsLength){</span>
...
<span class="cstat-no" title="statement not covered" >        if (argsLength === 1){</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        res = Array.prototype.concat.call(res, result);</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Detect(){</span>
...
&nbsp;
  ...
  var W2 = <span class="fstat-no" title="function not covered" >function(){</span> <span class="cstat-no" title="statement not covered" >return new CallbackWrapper(2);}</span>;
&nbsp;
  var methods = {
...
<span class="cstat-no" title="statement not covered" >      var args = Array.prototype.slice.call(arguments);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (typeof args[args.length - 1] !== 'function' &amp;&amp; typeof args[args.length - 2] !== 'function'){</span>
        // No iterator function, no callback - ignore call.
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (typeof args[args.length - 2] !== 'function'){</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var wrapper = new Wrapper();</span>
<span class="cstat-no" title="statement not covered" >      if (wrapper.wrapArgs){</span>
<span class="cstat-no" title="statement not covered" >        args = wrapper.wrapArgs(args);</span>
      }
<span class="cstat-no" title="statement not covered" >      wrapAsyncCallToAllPages(this, func, args, wrapper);</span>
    };
  }
&nbsp;
