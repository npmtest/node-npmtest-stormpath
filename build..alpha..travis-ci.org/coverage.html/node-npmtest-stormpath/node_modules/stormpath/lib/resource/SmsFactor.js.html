...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/resource/SmsFactor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/resource/SmsFactor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/resource/</a> &#187; SmsFactor.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function SmsFactor() {</span>
<span class="cstat-no" title="statement not covered" >  SmsFactor.super_.apply(this, arguments);</span>
}
&nbsp;
 ...
 * });
*/
SmsFactor.prototype.createChallenge = <span class="fstat-no" title="function not covered" >function createFactorChallenge(/* challenge, [options], callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['challenge', 'options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource(this.challenges.href, args.options, args.challenge, require('./Challenge'), args.callback);</span>
};
&nbsp;
&nbsp;
/**
...
*/
SmsFactor.prototype.getPhone = <span class="fstat-no" title="function not covered" >function getPhone(/* callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.phone.href, args.options, require('./Phone'), args.callback);</span>
};
&nbsp;
