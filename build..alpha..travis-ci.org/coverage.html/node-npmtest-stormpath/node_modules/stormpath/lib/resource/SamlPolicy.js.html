...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/resource/SamlPolicy.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/resource/SamlPolicy.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/resource/</a> &#187; SamlPolicy.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function SamlPolicy() {</span>
<span class="cstat-no" title="statement not covered" >  SamlPolicy.super_.apply(this, arguments);</span>
}
&nbsp;
 ...
 */
SamlPolicy.prototype.getServiceProvider = <span class="fstat-no" title="function not covered" >function getServiceProvider(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.serviceProvider.href, args.options, require('./SamlServiceProvider'), args.callback);</span>
};
&nbsp;
