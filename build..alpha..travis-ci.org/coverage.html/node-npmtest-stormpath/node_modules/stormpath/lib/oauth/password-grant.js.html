...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/oauth/password-grant.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/password-grant.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/</a> &#187; password-grant.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function OAuthPasswordGrantAuthenticationResult(application,accessTokenResponse){</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof OAuthPasswordGrantAuthenticationResult)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  OAuthPasswordGrantAuthenticationResult.super_.apply(this, arguments);</span>
&nbsp;
  /**
   * The access token response from the Stormpath REST API.
   *
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.accessTokenResponse = accessTokenResponse;</span>
}
&nbsp;
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function OAuthPasswordGrantRequestAuthenticator(application) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof OAuthPasswordGrantRequestAuthenticator)) {</span>
<span class="cstat-no" title="statement not covered" >    return new OAuthPasswordGrantRequestAuthenticator(application);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  OAuthPasswordGrantRequestAuthenticator.super_.apply(this, arguments);</span>
&nbsp;
 ...
 *
 */
OAuthPasswordGrantRequestAuthenticator.prototype.authenticate = <span class="fstat-no" title="function not covered" >function authenticate(formData, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var application = this.application;</span>
...
<span class="cstat-no" title="statement not covered" >    var href = application.href + '/oauth/token';</span>
<span class="cstat-no" title="statement not covered" >    formData.grant_type='password';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var form = util.extend({}, formData);</span>
&nbsp;
    // No need to send the scope to the API
<span class="cstat-no" title="statement not covered" >    if (form.scope) {</span>
<span class="cstat-no" title="statement not covered" >      delete form.scope;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    application.dataStore.createResource(href, {form: form}, <span class="fstat-no" title="function not covered" >function(err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >      if(err){</span>
<span class="cstat-no" title="statement not covered" >        return callback(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      self.scopeAuthResult(application, formData, data, OAuthPasswordGrantAuthenticationResult, callback);</span>
    });
  }
};
&nbsp;
