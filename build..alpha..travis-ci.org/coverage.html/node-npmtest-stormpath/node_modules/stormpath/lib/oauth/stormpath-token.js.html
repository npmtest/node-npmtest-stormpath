...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/oauth/stormpath-token.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/stormpath-token.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/</a> &#187; stormpath-token.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function OAuthStormpathTokenAuthenticationResult(application, data){</span>
<span class="cstat-no" title="statement not covered" >  OAuthStormpathTokenAuthenticationResult.super_.apply(this, arguments);</span>
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function OAuthStormpathTokenAuthenticator(application) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof OAuthStormpathTokenAuthenticator)) {</span>
<span class="cstat-no" title="statement not covered" >    return new OAuthStormpathTokenAuthenticator(application);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  OAuthStormpathTokenAuthenticator.super_.apply(this, arguments);</span>
&nbsp;
 ...
 *
 */
OAuthStormpathTokenAuthenticator.prototype.authenticate = <span class="fstat-no" title="function not covered" >function authenticate(data, callback) {</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('The \'data\' parameter must be an object.');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var scopeFactoryData = util.extend({}, formData, {scope: data.scope});</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.scopeAuthResult(application, scopeFactoryData, tokenData, OAuthStormpathTokenAuthenticationResult, callback);</span>
  });
};
&nbsp;
module.exports = {
