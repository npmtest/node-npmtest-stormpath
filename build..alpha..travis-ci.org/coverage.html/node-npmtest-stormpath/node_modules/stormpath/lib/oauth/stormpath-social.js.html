...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/oauth/stormpath-social.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/stormpath-social.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/</a> &#187; stormpath-social.js</div>
</div>
<div class="body">
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function OAuthStormpathSocialAuthenticator(application) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof OAuthStormpathSocialAuthenticator)) {</span>
<span class="cstat-no" title="statement not covered" >    return new OAuthStormpathSocialAuthenticator(application);</span>
  }
&nbsp;
 ...
 * });
 */
OAuthStormpathSocialAuthenticator.prototype.authenticate = <span class="fstat-no" title="function not covered" >function authenticate(authenticationRequest, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var application = this.application;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof authenticationRequest !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('The \'authenticationRequest\' parameter must be an object.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof authenticationRequest.providerId !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('The \'authenticationRequest.providerId\' parameter must be a string.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!authenticationRequest.code &amp;&amp; !authenticationRequest.accessToken) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('One of the parameters \'authenticationRequest.code\' or \'authenticationRequest.accessToken\' must be provided.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof callback !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('The \'callback\' parameter must be a function.');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var tokenHref = application.href + '/oauth/token';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  application.dataStore.createResource(tokenHref, { form: formData }, <span class="fstat-no" title="function not covered" >function(err, tokenData) {</span></span>
