...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/authc/StormpathAssertionAuthenticator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/authc/StormpathAssertionAuthenticator.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/authc/</a> &#187; StormpathAssertionAuthenticator.js</div>
</div>
<div class="body">
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function StormpathAssertionAuthenticator(application) {</span>
<span class="cstat-no" title="statement not covered" >  Object.defineProperty(this, 'dataStore', {</span>
    enumerable:false,
    value: application.dataStore
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.secret = this.dataStore.requestExecutor.options.client.apiKey.secret;</span>
}
&nbsp;
/**
 ...
 * });
 */
StormpathAssertionAuthenticator.prototype.authenticate = <span class="fstat-no" title="function not covered" >function authenticate(stormpathToken, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var dataStore = this.dataStore;</span>
<span class="cstat-no" title="statement not covered" >  njwt.verify(stormpathToken, this.secret, <span class="fstat-no" title="function not covered" >function (err, jwt) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (jwt.body.err){</span>
<span class="cstat-no" title="statement not covered" >      return callback(jwt.body.err);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var account = null;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (jwt.body.sub) {</span>
<span class="cstat-no" title="statement not covered" >      account = {</span>
        href: jwt.body.sub
      };
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, new AssertionAuthenticationResult(</span>
      dataStore, {
