...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/resource/Application.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-stormpath">npmtest-stormpath (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/resource/Application.js</span></h1>
    <h2>
        
        Statements: <span class="metric">19.93% <small>(54 / 271)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">20.15% <small>(54 / 268)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/resource/</a> &#187; Application.js</div>
</div>
<div class="body">
...
1506
1507
1508</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function Application() {</span>
<span class="cstat-no" title="statement not covered" >  Application.super_.apply(this, arguments);</span>
}
 ...
 * }));
 */
Application.prototype.createIdSiteUrl = <span class="fstat-no" title="function not covered" >function createIdSiteUrl(_options) {</span>
<span class="cstat-no" title="statement not covered" >  var options = typeof _options === "object" ? _options : {};</span>
<span class="cstat-no" title="statement not covered" >  var p = url.parse(this.href);</span>
<span class="cstat-no" title="statement not covered" >  var base = p.protocol + '//' + p.host;</span>
<span class="cstat-no" title="statement not covered" >  var apiKey = this.dataStore.requestExecutor.options.client.apiKey;</span>
<span class="cstat-no" title="statement not covered" >  var nonce = uuid();</span>
<span class="cstat-no" title="statement not covered" >  var state = options.state || '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(!options.callbackUri){</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(typeof options.showOrganizationField === 'boolean'){</span>
<span class="cstat-no" title="statement not covered" >    payload.sof = options.showOrganizationField;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(options.organizationNameKey){</span>
<span class="cstat-no" title="statement not covered" >    payload.onk = options.organizationNameKey;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(typeof options.useSubDomain === 'boolean'){</span>
<span class="cstat-no" title="statement not covered" >    payload.usd = options.useSubDomain;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(Array.isArray(options.require_mfa)){</span>
<span class="cstat-no" title="statement not covered" >    payload.require_mfa = options.require_mfa;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(Array.isArray(options.challenge)){</span>
<span class="cstat-no" title="statement not covered" >    payload.challenge = options.challenge;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var token = njwt.create(payload,apiKey.secret,'HS256');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var redirectUrl = base + '/sso'+(options.logout?'/logout':'')+'?jwtRequest=' + token;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return redirectUrl;</span>
};
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var dataStore = this.dataStore;</span>
<span class="cstat-no" title="statement not covered" >  var secret = dataStore.requestExecutor.options.client.apiKey.secret;</span>
<span class="cstat-no" title="statement not covered" >  var apiKeyId = dataStore.requestExecutor.options.client.apiKey.id;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var responseJwt = this._decodeJwt(token,secret);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  dataStore.nonceStore.getNonce(nonce,<span class="fstat-no" title="function not covered" >function(err,value){</span></span>
...
<span class="cstat-no" title="statement not covered" >      dataStore.nonceStore.putNonce(nonce,utils.noop);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      dataStore.getResource(accountHref,Account,<span class="fstat-no" title="function not covered" >function(err,account){</span></span>
<span class="cstat-no" title="statement not covered" >        if(err){</span>
<span class="cstat-no" title="statement not covered" >          cb(err);</span>
        }else{
          /**
 ...
 * };
 */
Application.prototype.authenticateAccount = <span class="fstat-no" title="function not covered" >function authenticateApplicationAccount(authenticationRequest, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var _this = this,</span>
    username = authenticationRequest.username,
    password = authenticationRequest.password,
    type = authenticationRequest.type || 'basic';
<span class="cstat-no" title="statement not covered" >  var accountStore = ('string' === typeof authenticationRequest.accountStore) ?</span>
    {href: authenticationRequest.accountStore} :
    authenticationRequest.accountStore;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var loginAttempt = {</span>
    type: type,
    value: utils.base64.encode(username + ':' + password)
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (authenticationRequest.accountStore){</span>
<span class="cstat-no" title="statement not covered" >    loginAttempt.accountStore = accountStore;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  _this.dataStore.createResource(</span>
    _this.loginAttempts.href,
    {expand: 'account'},
    loginAttempt,
    AuthenticationResult,
<span class="fstat-no" title="function not covered" >    function(err,authenticationResult){</span>
<span class="cstat-no" title="statement not covered" >      if(err){</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
      }
      else{
<span class="cstat-no" title="statement not covered" >        authenticationResult.application = _this;</span>
<span class="cstat-no" title="statement not covered" >        callback(null,authenticationResult);</span>
      }
  });
};
&nbsp;
 ...
 * });
 */
Application.prototype.sendPasswordResetEmail = <span class="fstat-no" title="function not covered" >function sendApplicationPasswordResetEmail(passwordResetRequest, callback) {</span>
  // @TODO - deprecate the string-only version
<span class="cstat-no" title="statement not covered" >  var data = typeof passwordResetRequest === 'string' ? {</span>
    email: passwordResetRequest
  } : passwordResetRequest;
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource(this.passwordResetTokens.href, null, data, PasswordResetToken, callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Application.prototype.resendVerificationEmail = <span class="fstat-no" title="function not covered" >function resendVerificationEmail(resendVerificationEmailRequest, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource(this.verificationEmails.href, resendVerificationEmailRequest, callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Application.prototype.verifyPasswordResetToken = <span class="fstat-no" title="function not covered" >function verifyApplicationPasswordResetToken(passwordResetToken, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var href = this.passwordResetTokens.href + '/' + passwordResetToken;</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(href, callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var href = this.passwordResetTokens.href + '/' + token;</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource(href, {expand: 'account'}, { password: password }, callback);</span>
};
&nbsp;
/**
 ...
 */
Application.prototype.getSamlPolicy = <span class="fstat-no" title="function not covered" >function getSamlPolicy(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.samlPolicy.href, args.options, require('./SamlPolicy'), args.callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.accounts.href, args.options, require('./Account'), args.callback);</span>
};
&nbsp;
/**
 * @description
 ...
 * });
 */
Application.prototype.getAccount = <span class="fstat-no" title="function not covered" >function getAccount(/* providerData, [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['providerData', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!args.callback || !args.providerData || !args.providerData.providerData) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Incorrect usage. Usage: Application.getAccount(providerData, [options], callback);');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var providerData = args.providerData.providerData;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof providerData !== 'object' || typeof providerData.providerId !== 'string' || (typeof providerData.code !== 'string' &amp;&amp; typeof providerData.accessToken !== 'string')) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('This method is used to create or access social accounts only. Did you mean to call Client.getAccount(href)?');</span>
  }
&nbsp;
 ...
 * });
 */
Application.prototype.createAccount = <span class="fstat-no" title="function not covered" >function createApplicationAccount(/* account, [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['account', 'options', 'callback']);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource(this.accounts.href, args.options, args.account, require('./Account'), args.callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.groups.href, args.options, require('./Group'), args.callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Application.prototype.getOAuthPolicy = <span class="fstat-no" title="function not covered" >function getOAuthPolicy(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.oAuthPolicy.href, args.options, require('./OAuthPolicy'), args.callback);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.tenant.href, args.options, require('./Tenant'), args.callback);</span>
};
&nbsp;
/**
 * @description
 ...
 * });
 */
Application.prototype.getApiKey = <span class="fstat-no" title="function not covered" >function getApiKey(apiKeyId, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var argCount = Array.prototype.slice.call(arguments).length;</span>
<span class="cstat-no" title="statement not covered" >  var cb = argCount === 3 ? callback : options;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var dataStore = this.dataStore;</span>
<span class="cstat-no" title="statement not covered" >  var opts = _.extend({},dataStore.apiKeyEncryptionOptions,argCount === 3 ? options : {id:apiKeyId});</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return dataStore.getResource(this.apiKeys.href, opts, require('./ApiKey'), <span class="fstat-no" title="function not covered" >function(err,result){</span></span>
<span class="cstat-no" title="statement not covered" >    if(err){</span>
<span class="cstat-no" title="statement not covered" >      cb(err);</span>
    }else <span class="cstat-no" title="statement not covered" >if(result instanceof require('./ApiKey')){</span>
      // this happens if we found it in the cache. manually 'expand' the account
<span class="cstat-no" title="statement not covered" >      dataStore.getResource(result.account.href,<span class="fstat-no" title="function not covered" >function(err,account){</span></span>
<span class="cstat-no" title="statement not covered" >        if(err){ <span class="cstat-no" title="statement not covered" >cb(err); </span>}else{</span>
<span class="cstat-no" title="statement not covered" >          result.account = account;</span>
<span class="cstat-no" title="statement not covered" >          cb(null,result);</span>
        }
      });
&nbsp;
    }else <span class="cstat-no" title="statement not covered" >if(result &amp;&amp; result.items &amp;&amp; result.items.length === 1 ){</span>
<span class="cstat-no" title="statement not covered" >      cb(null,result.items[0]);</span>
    }else{
<span class="cstat-no" title="statement not covered" >      var error = new Error('ApiKey not found');</span>
 ...
 * });
 */
Application.prototype.authenticateApiRequest = <span class="fstat-no" title="function not covered" >function authenticateApiRequest(options,callback) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(typeof options.request!=='object'){</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(options.ttl &amp;&amp; (typeof options.ttl!=='number')){</span>
<span class="cstat-no" title="statement not covered" >    throw new ApiAuthRequestError({userMessage: 'ttl must be a number'});</span>
  }
<span class="cstat-no" title="statement not covered" >  var validAccessTokenRequestLocations = ['header','body','url'];</span>
<span class="cstat-no" title="statement not covered" >  var defaultAccessTokenRequestLocations = ['header','body'];</span>
<span class="cstat-no" title="statement not covered" >  var locationsToSearch;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(Array.isArray(options.locations)){</span>
<span class="cstat-no" title="statement not covered" >    locationsToSearch = options.locations.filter(<span class="fstat-no" title="function not covered" >function(location){</span></span>
<span class="cstat-no" title="statement not covered" >      return validAccessTokenRequestLocations.indexOf(location) &gt; -1;</span>
    });
  }else{
<span class="cstat-no" title="statement not covered" >    locationsToSearch = defaultAccessTokenRequestLocations;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var ttl = options.ttl;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var req = options.request;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var scopeFactory = typeof options.scopeFactory === 'function' ? options.scopeFactory : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var parser = new AuthRequestParser(req,locationsToSearch);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var authHeaderValue = parser.authorizationValue;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var accessToken = parser.accessToken;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var grantType = parser.grantType;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(grantType &amp;&amp; grantType!=='client_credentials'){</span>
<span class="cstat-no" title="statement not covered" >    return callback(new ApiAuthRequestError({userMessage: 'Unsupported grant_type'}));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var authenticator;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(authHeaderValue){</span>
<span class="cstat-no" title="statement not covered" >    if(authHeaderValue.match(/Basic/i)){</span>
<span class="cstat-no" title="statement not covered" >      if(grantType){</span>
<span class="cstat-no" title="statement not covered" >        authenticator = new OAuthBasicExchangeAuthenticator(</span>
          this,
          req,
          ttl,
          scopeFactory,
...
<span class="cstat-no" title="statement not covered" >        authenticator = new BasicApiAuthenticator(</span>
          this,
          authHeaderValue,
          ttl
        );
      }
    }else <span class="cstat-no" title="statement not covered" >if(authHeaderValue.match(/Bearer/i)){</span>
<span class="cstat-no" title="statement not covered" >      authenticator = new OauthAccessTokenAuthenticator(</span>
        this,
        authHeaderValue.replace(/Bearer /i,''),
        ttl
      );
    }else{
<span class="cstat-no" title="statement not covered" >      return callback(new ApiAuthRequestError({userMessage: 'Invalid Authorization value', statusCode: 400}));</span>
    }
  }else <span class="cstat-no" title="statement not covered" >if(accessToken){</span>
<span class="cstat-no" title="statement not covered" >    authenticator = new OauthAccessTokenAuthenticator(this, accessToken, ttl);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(!authenticator){</span>
<span class="cstat-no" title="statement not covered" >    return callback(new ApiAuthRequestError({userMessage: 'Must provide access_token.', statusCode: 401}));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(authenticator instanceof Error){</span>
<span class="cstat-no" title="statement not covered" >    return callback(authenticator);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  authenticator.authenticate(callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
Application.prototype.getAccountStoreMappings = <span class="fstat-no" title="function not covered" >function getAccountStoreMappings(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.accountStoreMappings.href, args.options, ApplicationAccountStoreMapping, args.callback);</span>
};
&nbsp;
 ...
 * });
 */
Application.prototype.getDefaultAccountStore = <span class="fstat-no" title="function not covered" >function getDefaultAccountStore(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!this.defaultAccountStoreMapping) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.defaultAccountStoreMapping.href, args.options, ApplicationAccountStoreMapping, args.callback);</span>
};
&nbsp;
/**
 ...
 *
 */
Application.prototype.setDefaultAccountStore = <span class="fstat-no" title="function not covered" >function setDefaultAccountStore(store, callback) {</span>
...
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!this.defaultGroupStoreMapping) {</span>
<span class="cstat-no" title="statement not covered" >    return args.callback();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.defaultGroupStoreMapping.href, args.options, ApplicationAccountStoreMapping, args.callback);</span>
};
&nbsp;
/**
 ...
 *
 */
Application.prototype.createAccountStoreMapping = <span class="fstat-no" title="function not covered" >function createAccountStoreMapping(/* mapping, [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['mapping', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  args.mapping = new ApplicationAccountStoreMapping(args.mapping).setApplication(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.dataStore.createResource('/accountStoreMappings', args.options, args.mapping, ApplicationAccountStoreMapping, args.callback);</span>
};
&nbsp;
/**
 ...
 */
Application.prototype.createAccountStoreMappings = <span class="fstat-no" title="function not covered" >function createAccountStoreMappings(mappings,callback){</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  async.mapSeries(mappings,<span class="fstat-no" title="function not covered" >function(mapping,next){</span></span>
<span class="cstat-no" title="statement not covered" >    self.createAccountStoreMapping(mapping,next);</span>
  },callback);
};
&nbsp;
/*
 ...
 */
Application.prototype.getCustomData = <span class="fstat-no" title="function not covered" >function getCustomData(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.customData.href, args.options, require('./CustomData'), args.callback);</span>
};
&nbsp;
/**
...
*/
Application.prototype.getAccountLinkingPolicy = <span class="fstat-no" title="function not covered" >function getApplicationAccountLinkingPolicy(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.accountLinkingPolicy.href, args.options, require('./AccountLinkingPolicy'), args.callback);</span>
};
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 17:02:41 GMT+0000 (UTC)</div>
</div>
</body>
</html>
