...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-stormpath/node_modules/stormpath/lib/oauth/scope-factory-authenticator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/scope-factory-authenticator.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-stormpath/node_modules/stormpath/lib/oauth/</a> &#187; scope-factory-authenticator.js</div>
</div>
<div class="body">
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function ScopeFactoryAuthenticator() {</span>}
&nbsp;
/**
 * @function
 *
 ...
 */
ScopeFactoryAuthenticator.prototype.setScopeFactory = <span class="fstat-no" title="function not covered" >function setAuthenticatorScopeFactory(scopeFactory) {</span>
<span class="cstat-no" title="statement not covered" >  this.scopeFactory = scopeFactory;</span>
};
&nbsp;
/**
 * @function
 ...
 */
ScopeFactoryAuthenticator.prototype.setScopeFactorySigningKey = <span class="fstat-no" title="function not covered" >function setSigningKey(signingKey) {</span>
<span class="cstat-no" title="statement not covered" >  this.signingKey = signingKey;</span>
};
&nbsp;
/**
 * @function
 ...
 */
ScopeFactoryAuthenticator.prototype.scopeAuthResult = <span class="fstat-no" title="function not covered" >function scopeAuthenticatorResult(application, formData, responseData, Ctor, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof this.scopeFactory === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    return callback(null, new Ctor(application, responseData));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof this.signingKey === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    callback(new Error('Signing key required for expanding the authentication result token through scope factories. Please use `setSigningKey` first'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  njwt.verify(responseData.access_token, this.signingKey, <span class="fstat-no" title="function not covered" >function(err, token) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var responseInstance = new Ctor(application, responseData);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.scopeFactory(responseInstance, formData.scope, <span class="fstat-no" title="function not covered" >function(err, grantedScope) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        return callback(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (grantedScope) {</span>
<span class="cstat-no" title="statement not covered" >        token.body.scope = grantedScope;</span>
<span class="cstat-no" title="statement not covered" >        token.setSigningKey(self.signingKey);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        responseData.access_token = token.compact();</span>
<span class="cstat-no" title="statement not covered" >        responseInstance = new Ctor(application, responseData);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      callback(null, responseInstance);</span>
    });
  });
};
&nbsp;
